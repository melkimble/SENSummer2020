...
KJ_DocTermMatrix <- DocumentTermMatrix(KJ_words)

MT_DocTermMatrix <- DocumentTermMatrix(MT_words)

MS_DocTermMatrix <- DocumentTermMatrix(MS_words)

PPH_DocTermMatrix <- DocumentTermMatrix(PPH_words)

SJ_DocTermMatrix <- DocumentTermMatrix(SJ_words)
