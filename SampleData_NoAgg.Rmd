...
* n-grams (n-grams and stopwords are interchangable)
* fix stopwords
...
* start thematically coding (NVIVO - BIG - WHAT ARE NARRATIVES!?!?!? HOW DO THEY BREAK DOWN!?!?!?)
* (might not work) deep learning on thematic labels -> predict back to entire corpus -> construct timeline
